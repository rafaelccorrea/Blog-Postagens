...
rota.get('/posts',eAdmin, function(req,res) {
...
rota.get('/add', eAdmin, function(req,res) {
    res.render("admin/add")
})


rota.post("/categorias/nova", eAdmin, function(req,res) {
...
rota.get("/categorias/edit/:id", eAdmin, function(req, res){
...
rota.post("/categorias/edit", eAdmin, function(req, res){
...
rota.post("/categorias/deletar/:id", eAdmin, function(req, res){
...
rota.get("/postagens", eAdmin, function(req, res) {
...
rota.get("/postagem/add",eAdmin,function(req, res){
...
rota.post("/postagens/nova",eAdmin,(req, res)=> {
    var erros = []
...
rota.get("/postagens/edit/:id", eAdmin, function(req, res){
...
rota.post("/postagem/edit", eAdmin, (req,res)=>{
...
rota.get("/postagens/deletar/:id", eAdmin, function(req, res){
